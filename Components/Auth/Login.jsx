...
const Login = () => {
    ...
    return ( <>
        <div className="form flex justify-center mt-8 w-full h-fit">
            <form className="flex flex-col w-1/2 h-fit p-10 mt-10 backdrop-blur-lg bg-black/40 rounded-xl" onSubmit={onSubmit}>
