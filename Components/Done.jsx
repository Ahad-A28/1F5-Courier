...
function Done() {
  ...
  <>
    ...
    <div className="flex flex-col items-center  mt-10 backdrop-blur-lg  bg-black/40  rounded-xl">
      ...
      <Link className="bg-pink-400 mt-4 text-lg rounded-lg p-2 font-semibold uppercase" to="/"><i className="fa-solid fa-left-long mr-3 mt-2 "></i>Go Back To Home</Link>
    </div>
    </div>
